...
layui.define(['layer', 'laytpl', 'form'], function (exports) {
    ...
    var MOD_NAME = 'treeTablet';  // 绑定事件的模块名
    // 改为同步加载css，避免滚动条补丁首次进入无效
    $.ajax({
        url: layui.cache.base + 'treeTable-lazy/treeTable.css',
        async: false,
    ...
    /** TreeTable类构造方法 */
    var TreeTablet = function (options) {
        // 表格默认参数
        var defaultOption = {
    ...
    /** 初始化表格 */
    TreeTablet.prototype.init = function () {
    ...
    /** 绑定各项事件 */
    TreeTablet.prototype.bindEvents = function () {
        var that = this;
        var options = this.options;
        var components = this.getComponents();
    ...
    /** 获取各个组件 */
    TreeTablet.prototype.getComponents = function () {
     ...
     * @returns {string}
     */
    TreeTablet.prototype.renderBody = function (data, indentSize, isHide) {
        var options = this.options;
     ...
     * @returns {string}
     */
    TreeTablet.prototype.renderBodyTr = function (d, indentSize, isHide, $tr) {
        var options = this.options;
        ...
        if ($tr) {
            ...
            htmlStr += '<tr class="' + classNames + '" id="del_'+d[treeOption.idName]+'" data-id="' + d[treeOption.idName] + '"';
     ...
     * @returns {string}
     */
    TreeTablet.prototype.renderBodyTd = function (d, indentSize, index, $td) {
        var options = this.options;
     ...
     * @param $tr 父级dom
     */
    TreeTablet.prototype.renderBodyAsync = function (d, $tr) {
        var that = this;
        var options = this.options;
        var components = this.getComponents();
        var $tbEmpty = components.$tbEmpty;
     ...
     * @param $tr 父级dom
     */
    TreeTablet.prototype.renderBodyData = function (data, d, $tr) {
        var that = this;
        var options = this.options;
        var components = this.getComponents();
        var $view = components.$view;
     ...
     * @param checked
     */
    TreeTablet.prototype.checkSubCB = function ($tr, checked) {
        var that = this;
        var components = this.getComponents();
     ...
     * @param $tr 父级的dom
     */
    TreeTablet.prototype.checkParentCB = function ($tr) {
        var that = this;
        var components = this.getComponents();
        var cbFilter = components.checkboxFilter;
        var indent = parseInt($tr.data('indent'));
    ...
    /** 联动全选复选框 */
    TreeTablet.prototype.checkChooseAllCB = function () {
        var components = this.getComponents();
        var cbAllFilter = components.cbAllFilter;
        var cbFilter = components.checkboxFilter;
    ...
    /** 填充序号列 */
    TreeTablet.prototype.renderNumberCol = function () {
        var components = this.getComponents();
        var $tbody = components.$table.children('tbody');
    ...
    TreeTablet.prototype.checkIndeterminateCB = function () {
        var components = this.getComponents();
        var cbFilter = components.checkboxFilter;
     ...
     */
    TreeTablet.prototype.filterData = function (ids) {
        var components = this.getComponents();
    ...
    /** 重置搜索 */
    TreeTablet.prototype.clearFilter = function () {
        var components = this.getComponents();
        var $trList = components.$table.children('tbody').children('tr');
    ...
    /** 展开指定行 */
    TreeTablet.prototype.expand = function (id, cascade) {
        var components = this.getComponents();
    ...
    /** 折叠指定行 */
    TreeTablet.prototype.fold = function (id, cascade) {
        var components = this.getComponents();
        var $tr = components.$table.children('tbody').children('tr[data-id="' + id + '"]');
        if ($tr.hasClass('ew-tree-table-open')) {
            $tr.children('td').find('.ew-tree-pack').trigger('click');
    ...
    /** 全部展开 */
    TreeTablet.prototype.expandAll = function () {
        var that = this;
        var components = this.getComponents();
        var $trList = components.$table.children('tbody').children('tr');
        $trList.each(function () {
    ...
    /** 全部折叠 */
    TreeTablet.prototype.foldAll = function () {
        var that = this;
        var components = this.getComponents();
        var $trList = components.$table.children('tbody').children('tr');
        $trList.each(function () {
    ...
    /** 获取当前数据 */
    TreeTablet.prototype.getData = function () {
        return this.options.data;
    };

    /** 重载表格 */
    TreeTablet.prototype.reload = function (opt) {
        treeTb.render($.extend(this.options, opt));
    };

    /** 根据id更新数据 */
    TreeTablet.prototype.update = function (id, fields) {
        var data = getDataById(this.getData(), id, this.options.tree);
        $.extend(data, fields);
    };

    /** 根据id删除数据 */
    TreeTablet.prototype.del = function (id) {
        delDataById(this.getData(), id, this.options.tree);
    };

    /** 获取当前选中行 */
    TreeTablet.prototype.checkStatus = function (needIndeterminate) {
    ...
    /** 设置复/单选框选中 */
    TreeTablet.prototype.setChecked = function (ids) {
        var components = this.getComponents();
        var $table = components.$table;
        var checkboxFilter = components.checkboxFilter;
        var radioFilter = components.radioFilter;
    ...
    /** 移除全部选中 */
    TreeTablet.prototype.removeAllChecked = function () {
        var components = this.getComponents();
        var $table = components.$table;
        var checkboxFilter = components.checkboxFilter;
     ...
     */
    TreeTablet.prototype.refresh = function (id, data) {
        if (isClass(id) == 'Array') {
            data = id;
            id = undefined;
        }
