    ...
    (function( $ ){
        ...
        $(function() {
            ...
            uploader.on("uploadBeforeSend", function( object, data ) {
                let formData =  $('#DataForm').serializeArray(); //获取整个表单数据
                //let formData =  new FormData($('#demoData')[0]); //获取整个表单数据
                ...
                switch ( state ) {
                    ...
                    case 'finish':
                        ...
                        if ( stats.successNum ) {
                            //关闭弹出层
                            layer.closeAll();
                            layer.msg( '上传成功' ,{icon:1,time:1000,shade:0.3});
                            setTimeout(function(){
                                // 获得iframe索引
            ...
            uploader.onError = function( code ) {
                ...
                layer.msg( 'Eroor: ' + text );
            };

            //保存数据
            form.on('submit(imgSubmit)',function(obj){
                //layer.msg('66666666');
